...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '妮好~豪同学', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '还没想好', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://haoway.site', // 网站地址
